package com.isotton.agendadortarefas.controller;

import com.isotton.agendadortarefas.business.TarefasService;
...
public class TarefasController {
    ...
    @GetMapping("/eventos")
    public ResponseEntity<List<TarefasDTO>> buscaListaDeTaregasPorPeriodo(
